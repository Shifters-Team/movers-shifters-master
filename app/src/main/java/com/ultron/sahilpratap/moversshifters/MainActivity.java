...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_area, new MapFragment()).commit();
            navigationView.setCheckedItem(R.id.track);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (fragment != null){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_area, fragment).commit();
        }
